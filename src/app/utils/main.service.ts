...
export class MainService {
    ...
    getFields(name) {
        ...
        fields['power'] = [
            ...
            {
                name: 'netype_id',
                title: 'Managment.power.netype_id',
                type: 'selectApi',
                crud: 'cu',
                apiName: 'NEType',
                label: 'typeName',
        ...
        fields['SitePower'] = [
            ...
            {
                name: 'netype_id',
                title: 'Managment.SitePower.netype_id',
                type: 'selectApi',
                crud: 'cu',
                apiName: 'NEType',
                label: 'typeName',
        ...
        fields['rules'] = [
            ...
            {
                name: 'checklist_section_attr_id',
                title: 'Managment.rules.checklist_section_attr_id',
                type: 'selectApi',
                crud: 'cu',
                validators: [],
                apiName: 'checklist_attr',
                label: 'name',
                value: 'id',
                recordLabel: 'attr_name'
            },
            {
        ...
        fields['spareparts'] = [
            ...
            // { name: 'description',title: 'description',type:'text',crud:'r',validators:[] },
            {
                name: 'spareparts_type_id',
                title: 'Managment.spareparts.spareparts_type_id',
                type: 'selectApi',
                crud: 'cu',
                apiName: 'spareparts_type',
                label: 'name',
                value: 'id',
        ...
        fields['plan'] = [
            ...
            {
                name: 'locationVisitType',
                title: 'Managment.plan.locationVisitType',
                type: 'selectApi',
                crud: 'cu',
                validators: [],
                apiName: 'locationVisitType',
                label: 'type+loc_name',
                vlaue: 'locationVisitType_id',
                fun: (v) => {
                    v['type+loc_name'] = v['type'] + ' : ' + v['loc_name'];
                }
            },
        ...
        fields['core'] = [
            ...
            {
                name: 'netype_id',
                title: 'Managment.core.netype_id',
                type: 'selectApi',
                crud: 'cu',
                apiName: 'NEType',
                label: 'typeName',
        ...
        fields['radio'] = [
            ...
            {
                name: 'netype_id',
                title: 'Managment.radio.netype_id',
                type: 'selectApi',
                crud: 'cu',
                apiName: 'NEType',
                label: 'typeName',
        ...
        fields['router'] = [
            ...
            {
                name: 'netype_id',
                title: 'Managment.router.netype_id',
                type: 'selectApi',
                crud: 'cu',
                apiName: 'NEType',
                label: 'typeName',
        ...
        fields['NEType'] = [
            ...
            {
                name: 'product_id',
                title: 'Managment.NEType.product_id',
                type: 'selectApi',
                crud: 'cu',
                validators: [
                    {message: 'Managment.NEType.message', validator: Validators.required, name: 'required'},],
                apiName: 'product',
                label: 'name',
                value: 'id'
            },
        ...
        fields['checklista'] = [
            ...
            {
                name: 'product_id',
                title: 'Managment.checklista.product_id',
                type: 'selectApi',
                crud: 'cu',
                validators: [],
                apiName: 'product',
        ...
        fields['checklist'] = [
            {
                name: 'name',
                title: 'Managment.checklist.name',
                type: 'text',
                crud: 'crud',
                validators: [{message: 'Checklist Name is required', validator: Validators.required, name: 'required'},]
            },
            {
                name: 'visit_type_id',
                title: 'Managment.checklist.visit_type_id',
                type: 'selectApi',
                crud: 'cu',
                validators: [{message: 'Visit Type is required', validator: Validators.required, name: 'required'},],
                apiName: 'visitType',
                label: 'type',
                value: 'id'
            },
            ...
            {name: 'product_name', title: 'Managment.checklist.product_name', type: 'text', crud: 'r', validators: []},
            {
                ...
                fields: [
                    {
                        name: 'section_id',
                        title: 'Managment.checklist.fields.section_id',
                        type: 'selectApi',
                        crud: 'cu',
                        validators: [],
                        apiName: 'CheckListsection',
                        label: 'name',
                        value: 'id',
                        recordLabel: 'section_name'
                    },
                    {
                        name: 'equibment_id',
                        title: 'Managment.checklist.fields.equibment_id',
                        type: 'selectApi',
                        crud: 'cu',
                        validators: [],
                        apiName: 'equibment',
                        label: 'name',
                        value: 'id',
                        recordLabel: 'equibment_name'
                    },
                    {
                        name: 'attr_id',
                        title: 'Managment.checklist.fields.attr_id',
                        type: 'selectApi',
                        crud: 'cu',
                        validators: [],
                        apiName: 'checklist_attr',
        ...
        fields['team'] = [
            ...
            {name: 'team_is_active', title: 'Managment.team.team_is_active', type: 'checkbox', crud: 'crud', validators: []},
            {
                name: 'members', title: 'Managment.team.members', type: 'selectWithData', crud: 'cu', validators: [], fields: [
                    {
                        name: 'tem_mem_employee_id',
                        title: 'Managment.team.tem_mem_employee_id',
                        type: 'selectApi',
                        crud: 'cu',
                        validators: [],
                        apiName: 'employee',
        ...
        fields['teamType'] = [
            ...
            {
                name: 'tic_typ_if_is_critical',
                title: 'Managment.teamType.tic_typ_if_is_critical',
                type: 'text',
                crud: 'crud',
                validators: []
            },
        ...
        fields['locationTeam'] = [
            {
                name: 'location_id',
                title: 'Managment.locationTeam.location_id',
                type: 'selectApi',
                crud: 'cu',
                validators: [],
                apiName: 'location',
            ...
            {
                name: 'team_id',
                title: 'Managment.locationTeam.team_id',
                type: 'selectApi',
                crud: 'cu',
                validators: [],
                apiName: 'team',
            ...
            {
                name: 'team_type_id',
                title: 'Managment.locationTeam.team_type_id',
                type: 'selectApi',
                crud: 'cu',
                validators: [],
                apiName: 'teamType',
        ...
        fields['location'] = [
            ...
            {
                name: 'loc_city_id',
                title: 'Managment.location.loc_city_id',
                type: 'selectApi',
                validators: [],
                crud: 'cu',
                apiName: 'city',
            ...
            {
                name: 'loc_area_id',
                title: 'Managment.location.loc_area_id',
                type: 'selectApi',
                validators: [],
                crud: 'cu',
                apiName: 'area',
            ...
            {
                name: 'loc_has_authorization',
                title: 'Managment.location.loc_has_authorization',
                type: 'checkbox',
                crud: 'crud',
                validators: []
            },
        ...
        fields['employee'] = [
            ...
            {
                name: 'emp_unit_id',
                title: 'Managment.employee.emp_unit_id',
                type: 'selectApi',
                crud: 'uc',
                validators: [],
                apiName: 'unit',
            ...
            {
                name: 'emp_area_id',
                title: 'Managment.employee.emp_area_id',
                type: 'selectApi',
                crud: 'uc',
                validators: [],
                apiName: 'area',
        ...
        fields['locationVisitType'] = [
            ...
            {
                name: 'location_id',
                title: 'Managment.locationVisitType.location_id',
                type: 'selectApi',
                validators: [],
                crud: 'cu',
                apiName: 'location',
            ...
            {
                name: 'visitType_id',
                title: 'Managment.locationVisitType.visitType_id',
                type: 'selectApi',
                validators: [],
                crud: 'cu',
                apiName: 'visitType',
            ...
            {
                name: 'checkLists_id',
                title: 'Managment.locationVisitType.checklists_id',
                type: 'selectApi',
                validators: [],
                crud: 'cu',
                apiName: 'checklist',
        ...
        fields['permissions'] = [
            ...
            {
                name: 'location_id',
                title: 'Managment.permissions.location_id',
                type: 'selectApi',
                crud: 'cu',
                validators: [],
                apiName: 'location',
            ...
            {
                name: 'emp_id',
                title: 'Managment.permissions.emp_id',
                type: 'selectApi',
                crud: 'cu',
                validators: [],
                apiName: 'employee',
            ...
            {
                name: 'is_permition',
                title: 'Managment.permissions.is_permition',
                type: 'radio',
                crud: 'crud',
                validators: [],
                choices: [{label: 'permission', value: '1'}, {label: 'authorization', value: '0'}]
            },
        ];
        ...
        fields['locationGenerator'] = [
            {
                name: 'location_id',
                title: 'Managment.locationGenerator.location_id',
                type: 'selectApi',
                validators: [],
                crud: 'cu',
                apiName: 'location',
            ...
            {
                name: 'netype_id',
                title: 'Managment.locationGenerator.netype_id',
                type: 'selectApi',
                crud: 'cu',
                apiName: 'NEType',
                label: 'typeName',
        ...
        fields['Role'] = [
            ...
            {
                name: 'privilege',
                title: 'Managment.Role.privilege',
                type: 'selectApi',
                crud: 'cu',
                validators: [],
                apiName: 'Privilege',
                label: 'pri_display_name',
                value: 'pri_id',
                multiple: true
            },
