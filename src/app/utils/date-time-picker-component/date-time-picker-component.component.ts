...
const DATE_TIME_PICKER_CONTROL_VALUE_ACCESSOR: any = {
  ...
  useExisting: forwardRef(() => DateTimePickerComponentComponent),
  multi: true
};
@Component({
  selector: 'date-time-picker-component',
  templateUrl: './date-time-picker-component.component.html',
  styleUrls: ['./date-time-picker-component.component.scss'],
  providers: [DATE_TIME_PICKER_CONTROL_VALUE_ACCESSOR]
})
export class DateTimePickerComponentComponent implements OnInit,ControlValueAccessor {
