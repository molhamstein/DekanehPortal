...
export class ReportOrderComponent implements OnInit {
  ...
  products = []
  constructor(private Handler: OrdersHandlerService, private prodHandler: ProductHandler, private router: Router, private route: ActivatedRoute, private alert: AlertService) {
