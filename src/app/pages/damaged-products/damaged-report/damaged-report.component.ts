...
@Component({
  selector: 'app-damaged-report',
  templateUrl: './damaged-report.component.html',
  styleUrls: ['./damaged-report.component.css']
})
export class ReportDamagedComponent implements OnInit {
  today = new Date();
